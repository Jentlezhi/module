//
//  CYTSeekCarSearchTableController.m
//  CYTEasyPass
//
...
@interface CYTSeekCarSearchTableController ()<UIGestureRecognizerDelegate>
...
@implementation CYTSeekCarSearchTableController
...
- (CYTCarSearchVM *)viewModel {
    if (!_viewModel) {
        ...
        model.ffIndex = CarViewSourceSeekCar;
